...
public class GroupGene extends IntegerGene implements Gene, Serializable {
  ...
  private Integer max_idGroup = 3;
  private Integer max_groupSize = 30;
  private Integer idGroup;
  private Integer groupSize;

  public GroupGene(Configuration a_conf, Integer a_idGroup,
                   Integer a_groupSize) throws InvalidConfigurationException {
    super(a_conf);
    if (a_idGroup < 0) {
  ...
  public void setMax_idGroup(Integer max_idGroup) {
    this.max_idGroup = max_idGroup;
  }
}
